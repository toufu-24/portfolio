...
export default async function Home() {
  ...
  try {
    ...
    githubStats = { contributionsLastYear: 0, publicRepos: 0, totalStars: 0, followers: 0 };
  }
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-800 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-gray-100">{githubStats?.contributionsLastYear ?? 0}</div>
                  <div className="text-sm text-gray-400">Contributions (Last Year)</div>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-gray-100">{githubStats?.publicRepos ?? 0}</div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                ...
                <span className="text-xl font-bold text-gray-100">{githubStats?.totalStars ?? 0}</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-gray-100">{githubStats?.followers ?? 0}</span>
              </div>
              <a
